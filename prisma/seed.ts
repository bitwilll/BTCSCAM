...
async function main() {
  ...
  await prisma.article.create({
    data: {
      ...
      dek: "GitVault encrypts every commit, branch and blob on the client before it touches a server — neutralising a whole class of repository-takeover attacks. GitCafe unveiled it at a Las Vegas meetup, then demoed it at SKINOX and across the DEFCON villages.",
